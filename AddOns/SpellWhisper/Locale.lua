...
elseif locale == "zhTW" then --Taiwan is a part of China forever
    ...
    L["Gift of Life"] = "生命賜福"
    --載入提示文字
    L["|cFFBA55D3SpellWhisper|r v%s|cFFB0C4DE is Loaded.|r"] = "|cFFBA55D3技能通報|r v%s已|cFFB0C4DE成功|r載入！"
    L["Now is |cFF00FFFFEnabled|r."] = "當前已|cFF00FFFF啟用|r。"
    L["Now is |cFF00FFFFDisabled|r."] = "當前已|cFF00FFFF禁用|r。"
    L["|cFFBA55D3SpellWhisper|r v%s is |cFFFF4C00Out of date|r. Goto %s for |cFFF48CBANew Version.|r"] = "|cFFBA55D3 技能通報|r v%s已|cFFFF4C00過期|r，請用|cFF00FFFF桃樂豆|r|cFFFFF468更新|r或前往%s|cFFFFF468下載|r|cFFF48CBA最新版本|r。"
    L["<|cFFBA55D3SW|r>Start Check Team Member's |cFFBA55D3SpellWhisper|r Version."] = "<|cFFBA55D3SW|r>開始檢查團隊成員 技能通報 插件版本。"
    L["<|cFFBA55D3SW|r>Don't Have Any Team Member(s)."] = "<|cFFBA55D3SW|r>不在一個隊伍或團隊中。"
    L["<|cFFBA55D3SW|r>Can't Check |cFFBA55D3SpellWhisper|r Version In Battleground."] = "<|cFFBA55D3SW|r>無法在戰場中檢查插件版本。"
    L["<|cFFBA55D3SW|r>Please Enable |cFFBA55D3SpellWhisper|r First."] = "<|cFFBA55D3SW|r>請先啟用|cFFBA55D3技能通報|r插件。"
    --Slash Command提示文字
    L["<|cFFBA55D3SW|r>Can NOT Open |cFFBA55D3SpellWhisper|r GUI when you in COMBAT."] = "<|cFFBA55D3SW|r>戰鬥中無法打開|cFFBA55D3技能通報|r設置介面。"
