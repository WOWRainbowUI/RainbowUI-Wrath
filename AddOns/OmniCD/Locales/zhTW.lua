...
L["Attach Name Bar to the left of icon"] = "名字列對齊圖示左側"
...
L["Max Number of Visible Icons"] = "可顯示圖示的最大數量"
L["Minor update"] = "次要更新"
L["MM Color"] = "MM 顏色"
...
L["Reset current bar settings to default"] = "重置目前的條列設定，恢復成預設值"
...
L["Set the max number of icons that can be displayed per unit"] = "設定每個單位所能顯示的最多圖示數量"
L["Set the Name Bar name scale"] = "設定名字列的名字縮放大小"
...
L["Set the priority of spell types for sorting."] = "設定法術類型的優先權，供排序使用。"
...
L["The global font settings are in the General menu"] = "整體的文字設定在一般選單裡面"
...
L["Timers"] = "計時條"
L["Toggle \"Show Spell ID in Tooltips\" to retrieve item IDs"] = "啟用 [在浮動提示資訊中顯示法術 ID] 來取得物品 ID"
...
L["Tooltips will be enabled for this login session only."] = "只有此次登入會啟用浮動提示資訊。"
L["TOP"] = "上"
L["TOPLEFT"] = "左上"
L["TOPRIGHT"] = "右上"
L["Trinket and Racial abilities are excluded from sorting"] = "飾品和種族特長不包含在排序之內"
L["Trinket Items"] = "飾品"
L["Truncate Name"] = "截斷名字"
