...
ABC.main_panel.name = L["AutoBar Option"];
...
ABC.categories_panel.name = L["Custom Categories"];
...
AutoBarConfig.DebugFrame:SetName(L["Debug"], L["AutoBar Option"])
...
local function DrawGroupNamelessCategories(container)
	...
	button:SetText(L["Find Nameless Categories/Buttons"])
	button:SetWidth(200)
...
tab:SetTabs({{text=L["Nameless Categories"], value="tab1"}, {text=L["Warnings"], value="tab2"}})
-- Register callback
