...
--						},
						...
						handle_spell_changed = {
							...
							order = 504,
							width = 1.2,
							name = L["Allow SPELLS_CHANGED"],
							desc = L["If unchecked some spell-related messages will be ignored. This will improve performance, but may cause side-effects"],
						},
						hack_PetActionBarFrame = {
							type = "toggle",
							order = 505,
							width = 1.2,
							name = L["Hack PetActionBarFrame"],
							desc = L["Blizzard's PetActionBarFrame is larger than it looks and can block access to other things near it. When enabled this will make the frame ignore the Mouse"],
						},
						log_throttled_events = {
							type = "toggle",
							order = 540,
							width = 1.2,
							name = L["Log Throttled Events"]
						},
						throttle_event_limit = {
							type = "range",
							order = 541,
							width = 1.2,
							name = L["Throttle Event Limit"],
							desc = L["Events happening faster than this limit are ignored (in seconds)"],
