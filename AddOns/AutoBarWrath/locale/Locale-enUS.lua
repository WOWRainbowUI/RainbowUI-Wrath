...
if (GetLocale() == "enUS") then
	AutoBarGlobalDataObject.locale = {
		...
		["NewButtonTooltip"] = "Create new custom button",
		["Advanced/Debug"] = "Advanced/Debug",
		["Supporters"] = "Supporters",
		["AutoBar Supporters"] = "AutoBar Supporters",
		["AutoBar"] = "AutoBar",
		["AutoBar Option"] = "AutoBar",
		["Debug"] = "Debug",
		["Nameless Categories"] = "Nameless Categories",
		["Warnings"] = "Warnings",
		["Find Nameless Categories/Buttons"] = "Find Nameless Categories/Buttons",
		["Empty"] = "Empty",
		["Max Popup Height"] = "Max Popup Height",
		["Max Popup Height Desc"] = "Maximum Number of button rows for a popup",
		["Allow SPELLS_CHANGED"] = "Allow SPELLS_CHANGED",
		["If unchecked some spell-related messages will be ignored. This will improve performance, but may cause side-effects"] = "If unchecked some spell-related messages will be ignored. This will improve performance, but may cause side-effects",
		["Hack PetActionBarFrame"] = "Hack PetActionBarFrame",
		["Blizzard's PetActionBarFrame is larger than it looks and can block access to other things near it. When enabled this will make the frame ignore the Mouse"] = "Blizzard's PetActionBarFrame is larger than it looks and can block access to other things near it. When enabled this will make the frame ignore the Mouse",
		["Log Throttled Events"] = "Log Throttled Events",
		["Throttle Event Limit"] = "Throttle Event Limit",
		["Events happening faster than this limit are ignored (in seconds)"] = "Events happening faster than this limit are ignored (in seconds)",
		["Square Popups"] = "Square Popups",
		["Square Popups Desc"] = "Try to organize popups into more of a square shape",
		["Contributors"] = "Contributors",
		["AutoBar Contributors"] = "AutoBar Contributors",
