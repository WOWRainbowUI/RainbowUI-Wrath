...
if (GetLocale() == "zhTW") then
	AutoBarGlobalDataObject.locale = {
		["NewButton"] = "新增按鈕",
		["NewButtonTooltip"] = "建立新的自訂按鈕",
		["Advanced/Debug"] = "進階/除錯",
		["Supporters"] = "支援",
		["AutoBar Supporters"] = "自動快捷列支持人員",
		["AutoBar"] = "自動快捷列",
		["AutoBar Option"] = "快捷列-自動",
		["Debug"] = "除錯",
		["Nameless Categories"] = "未命名類別",
		["Warnings"] = "警告",
		["Find Nameless Categories/Buttons"] = "尋找未命名類別/按鈕",
		["CONFIG_WINDOW"] = "設定選項",
		["SLASHCMD_LONG"] = "autobar",
		["SLASHCMD_SHORT"] = "atb",
		["Button"] = "按鈕",
		["LOAD_ERROR"] = "|cff00ff00載入 AutoBarConfig 發生錯誤。請確定是否有這個插件，並啟用插件。|r錯誤: ",
		["Toggle the config panel"] = "切換自動快捷列設定視窗",
		["Empty"] = "空",
		["Max Popup Height"] = "最大彈出高度",
		["Max Popup Height Desc"] = "彈出選單的最多按鈕數量",
		["AutoBarButtonMana"] = "法力",
		["AutoBarButtonMillHerbs"] = "研磨",
		["AutoBarButtonAquatic"] = "水棲形態",
		["AutoBarButtonInterrupt"] = "斷法",
		["AutoBarButtonMoonkin"] = "梟獸形態",
		["AutoBarButtonRaidTarget"] = "團隊鎖定圖示",
		["AutoBarButtonReputation"] = "聲望",
		["AutoBarButtonTreeForm"] = "樹人形態",
		["AutoBarButtonTrack"] = "追蹤",
		["AutoBarButtonDrums"] = "戰鼓",
		["Allow SPELLS_CHANGED"] = "允許 SPELLS_CHANGED",
		["If unchecked some spell-related messages will be ignored. This will improve performance, but may cause side-effects"] = "取消勾選時，將會忽略一些法術相關的訊息。能夠改善效能，但可能會產生副作用。",
		["Hack PetActionBarFrame"] = "修改 PetActionBarFrame",
		["Blizzard's PetActionBarFrame is larger than it looks and can block access to other things near it. When enabled this will make the frame ignore the Mouse"] = "暴雪的 PetActionBarFrame 比它的外觀看起來還大，而且會擋住對它附近的東西的操作。啟用此選項會讓此框架忽略滑鼠動作。",
		["Log Throttled Events"] = "記錄限制事件",
		["Throttle Event Limit"] = "限制事件條件",
		["Events happening faster than this limit are ignored (in seconds)"] = "發生速度超過此限制的事件將被忽略 (以秒為單位)",
		["Raid 1"] = "團隊圖示 星星",
		["Raid 2"] = "團隊圖示 圈圈",
		["Raid 3"] = "團隊圖示 菱形",
		["Raid 4"] = "團隊圖示 三角",
		...
		["Raid 7"] = "團隊圖示 十字",
		["Raid 8"] = "團隊圖示 頭顱",
		["Square Popups"] = "方形彈出選單",
		["Square Popups Desc"] = "讓彈出選單盡量保持方形",
		["Contributors"] = "貢獻人員",
		["AutoBar Contributors"] = "自動快捷列貢獻人員",
		...
		["Done"] = "完成";
		["Drag"] = "拖曳",
		["Drag to move items, spells or macros using the Cursor"] = "使用滑鼠游標拖曳來移動物品、法術或巨集。",
		["Drop"] = "放入";
		["Drop items, spells or macros onto Button to add them to its top Custom Category"] = "將物品、法術或巨集放到按鈕上時，加入到所屬最上層的自訂類別中。";
		["Enabled"] = "啟用",
		["Enable %s."] = "啟用 %s",
		["FadeOut"] = "淡出",
		...
		["Reset the Bars to default Bar settings"] = "重置為物品列的預設設定值",
		["Revert"] = "復原";
		...
		-- Button Names
		["Buttons"] = "按鈕",
		["AutoBarButtonHeader"] = "自動快捷列按鈕",
		["AutoBarCooldownHeader"] = "藥水及石頭冷卻時間",
		["AutoBarClassBarHeader"] = "職業物品列",

		["AutoBarButtonAspect"] = "光環/守護",
		["AutoBarButtonPoisonLethal"] = "毒藥: 致命",
		["AutoBarButtonPoisonNonlethal"] = "毒藥: 非致命",
		...
		["AutoBarButtonClassPets2"] = "寵物戰鬥",
		["AutoBarButtonClassPets3"] = "寵物其他",
		["AutoBarButtonConjure"] = "法術: 製造",
		["AutoBarButtonOpenable"] = "可打開",
		...
		["AutoBarButtonMiscFun"] = "其他、趣味物品",
		["AutoBarButtonGuildSpell"] = "公會技能",
		...
		["AutoBarButtonBear"] = "熊形態",
		["AutoBarButtonBoomkinTree"] = "樹人/梟獸形態",
		["AutoBarButtonCat"] = "獵豹形態",
		["AutoBarButtonTravel"] = "旅行形態",
		...
		["Spell.Class.Pet"] = "職業寵物";
		["Spell.Class.Pets2"] = "寵物戰鬥";
		["Spell.Class.Pets3"] = "寵物其他";
		["Spell.Crafting"] = "專業技能";
		["Spell.Critter"] = "寵物法術";
...
--AUTOBAR_CONFIG_RESETSINGLETIP = "點擊將重置為單一角色設定的預設值。";
--AUTOBAR_CONFIG_RESETSHAREDTIP = "點擊將重置為角色共用設定的預設值。\n職業專用按鈕會複製到角色欄位。\n預設按鈕將複製到共用的欄位。";
--AUTOBAR_CONFIG_RESETSTANDARDTIP = "點擊將重置為標準預設值。\n職業專用按鈕會在職業欄位中。\n預設按鈕在基本欄位中。\n共用和角色欄位將會清除。";
