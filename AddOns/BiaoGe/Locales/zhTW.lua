...
do --繁体说明书
    ...
    text = text .. "|cffFFFFFF-跳轉光標：|r按Tab、Enter、方向鍵跳轉光標，ALT/CTRL/SHIFT+方向鍵跳轉至下個BOSS\n"
    ...
    update = update .. [[-增加薪水抹零選項]] .. "\n\n"

    update = update .. "|cff00FF00" .. "1月1日更新1.7.4b版本" .. "|r\n"
    update = update .. [[-一鍵舉報腳本按鈕現在也會顯示在隊員/團員框體的右鍵菜單裡（坐飛機順手來個舉報豈不美哉？）]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月31日更新1.7.4版本" .. "|r\n"
    update = update .. [[-在目標玩家的右鍵菜單裡增加<一鍵舉報腳本>按鈕。快捷命令：/BGReport]] .. "\n"
    update = update .. [[-集結號的搜索框現在支持多個關鍵詞搜索，每個關鍵詞用空格隔開（該功能默認關閉）]] .. "\n"
    update = update .. [[-集結號的額外功能現在可以直接在集結號的內置設置裡調整了]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月29日更新1.7.3d版本" .. "|r\n"
    update = update .. [[-修復了部分裝備會自動記錄兩次的問題]] .. "\n\n"
...
do --繁体更新内容
    ...
    update = update .. [[-<賽季服>如果你安裝了Auctionator插件，[遭劫貨物]的提示工具中會顯示所需貨物的拍賣行價格]] .. "\n"
    update = update .. [[-<賽季服>附魔分解材料現在不再自動記入表格]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月17日更新1.7.3版本" .. "|r\n"
    update = update .. [[-拍賣WA字符串更新至v1.1：調整了動態加價幅度以適配賽季服]] .. "\n"
    update = update .. [[-修復報錯]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月15日更新1.7.2版本" .. "|r\n"
    update = update .. [[-<賽季服>在貿易局聲望的遭劫貨物提示工具中增加具體的聲望獎勵]] .. "\n\n"
    update = update .. [[-<賽季服>裝備過濾詞綴增加"擊中時可能"（法系職業默認勾選）]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月13日更新1.7.1f版本" .. "|r\n"
    update = update .. [[-在裝備庫增加一個部位上下切換按鈕（同時也支持使用滾輪切換）]] .. "\n"
    update = update .. [[-修復繁體端錯誤]] .. "\n\n"

    update = update .. "|cff00FF00" .. "12月12日更新1.7.1e版本" .. "|r\n"
    update = update .. [[-裝備過濾詞綴現在會忽略套裝效果文本]] .. "\n"
    update = update .. [[-<賽季服>現在如果檢測到你的配置文件是WLK版的，則自動重置配置文件]] .. "\n\n"
