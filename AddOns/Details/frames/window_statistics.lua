                    ...
                    for dungeonEncounterID, encounterTable in pairs(encounterIdTable) do
                        if (allowedBosses[dungeonEncounterID]) then
                            ...
                            elseif (difficulty == 15) then
                                ...
                                if (not alreadyHave) then
                                    tinsert(difficultyList, 1, {value = difficulty, label = Loc["Heroic"], icon = icon, onclick = onDifficultySelect})
                                end
                            ...
                            elseif (difficulty == 16) then
                                ...
                                if (not alreadyHave) then
                                    tinsert(difficultyList, {value = difficulty, label = Loc["Mythic"], icon = icon, onclick = onDifficultySelect})
                                end
                            end
                        end
                    end
