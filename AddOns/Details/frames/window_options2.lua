...
function Details222.OptionsPanel.InitializeOptionsWindow(instance)
    ...
    local titleText = detailsFramework:NewLabel(titleBar, nil, "$parentTitleLabel", "title", "Details! " .. Loc ["STRING_OPTIONS_WINDOW"], "GameFontHighlightLeft", 16, {227/255, 186/255, 4/255})
    ...
    local instances_string = detailsFramework:NewLabel(footerFrame, nil, "$parentInstanceDropdownLabel", "instancetext", Loc ["STRING_OPTIONS_EDITINSTANCE"], "GameFontNormal", 16)
    ...
    local editingGroupLabel = detailsFramework:NewLabel(footerFrame, nil, "$parentEditingGroupLabel", "editingGroupLabel", Loc["Editing Group:"], "GameFontNormal", 16) --localize-me
    ...
    --search field
        ...
        local searchLabel = detailsFramework:CreateLabel(footerFrame, Loc["Search:"]) --localize-me
