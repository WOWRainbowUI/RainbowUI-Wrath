...
L["VERSION_TEXT"] = "Extended Vendor UI |cffa335ee[Classic Edition]|r %s";
...
L["OPTION_QUICKVENDOR_OUTDATEDGEAR_TOOLTIP"] = "If enabled, soulbound weapons and armor far\nbelow the player's level will\nbe included in the quick-vendor feature.";
