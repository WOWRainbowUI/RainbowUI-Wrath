...
L["No trades recorded yet"] = "還沒有任何交易記錄";
...
L["rightClickMinimapButton"] = "右鍵|r 打開出團記錄";
L["shiftLeftClickMinimapButton"] = "Shift+左鍵|r 打開交易記錄";
L["shiftRightClickMinimapButton"] = "Shift+右鍵|r 打開設定";
L["controlLeftClickMinimapButton"] = "Ctrl+左鍵|r 打開拾取記錄";
L["Merged"] = "合併";
...
L["showRaidCooldownsDesc"] = "加入團隊時，顯示團隊成員的副本冷卻記錄（按住 shift 拖動窗口）。";
...
L["maxRecordsKeptTitle"] = "團隊記錄資料庫大小";
...
L["maxTradesKeptTitle"] = "交易記錄資料庫大小";
...
L["You can't delete log entries while inside an instance."] = "你無法刪除你正在進行的副本記錄。";
