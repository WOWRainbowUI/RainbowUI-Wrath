        ...
        general = {
            ...
            args = {
                ...
                info= {
                    order = 1,
                    type = "description",
                    name = L["If you're missing the default totem bar, you have to disable the multicast button in the Timers section."]
                        ..L["The default totem bar and the multicast button in TT cannot be used reliably at the same time."],
                    fontSize = "medium",
                    image = 310730,
                    imageWidth = 26,
                    imageHeight = 26,
