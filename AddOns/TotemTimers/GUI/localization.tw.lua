...
L["Hide In Vehicles Desc"] = "騎乘時隱藏薩滿圖騰快捷列。騎乘時不要改變設定"
L["Lock"] = "鎖定"
L["Locks the position of TotemTimers"] = "鎖定薩滿圖騰快捷列位置"
L["RaidTotems"] = "團隊圖騰"
...
L["EarthShieldOptionsDesc"] = "如果為了滑鼠按鈕'改寫'像設定一樣被選擇，當離開戰鬥盾被施放在最後一人。預設用法: 離開戰鬥指向你大地之盾目標之後用右鍵點擊按鈕施放法術。那麼你可以指向任何一人，然而用右鍵點擊大地之盾仍然會施放在相同的人身上，甚至在戰鬥中。"
...
L["Color"] = "顏色"
L["disabled warnings desc"] = "即使停用追蹤，到期增益警告還是會顯示"
...
L["Spells"] = "法術"
L["MaelstromNumberOnlyDesc"] = "顯示數字而不是閃電"
...
--自行加入
L["TotemTimers"] = "薩滿圖騰"
L["Totem Timers"] = "薩滿圖騰快捷列"
L["Twisting Timer"] = "雙風計時器"
L["Shows twisting timer for %s"] = "為 %s 顯示雙風計時器"
L["Party Range"] = "小隊距離"
L["Party Range Position"] = "小隊距離位置"
L["Reset"] = "重置"
L["Show Charges Only"] = "只顯示充能次數"
L["Combat Cooldowns"] = "戰鬥冷卻"
L["Flame Shock duration"] = "烈焰震擊持續時間"
L["Flame shock duration is now changed for each spec in spells section below"] = "烈焰震擊持續時間現在改為在每個專精的分頁中設定"
L["Size"] = "大小"
L["Show Number Only"] = "只顯示數字"
L["Sets"] = "套組"
L["You did not create any totem sets yet."] = "尚未建立任何圖騰套組。"
L["Scenario"] = "事件"
L["No Sound"] = "沒有音效"
L["Multicast"] = "多重施法"
L["Enables button and functionality for Call of Elements etc."] = "啟用元素呼喚...等的按鈕和功能。"
L["Downrank %s"] = "%s降級"
L["Always use rank 1 for %s"] = "永遠使用等級 1 的%s"
L["If you're missing the default totem bar, you have to disable the multicast button in the Timers section."] = "如果預設的圖騰列不見了，請停用計時裡面的多重施法按鈕。"
L["The default totem bar and the multicast button in TT cannot be used reliably at the same time."] = "預設的圖騰列和薩滿圖騰快捷列的多重施法按鈕無法穩定的同時使用。"
L["TotemTimers: You might need to relog for the default totem bar to show/hide correctly"] = "薩滿圖騰快捷列: 需要重新登入角色才能正確的顯示/隱藏預設的圖騰列。"
L["Stop Pulse Animation"] = "停止脈衝動畫"
L["Demo"] = "示範"
L["Macro"] = "巨集"
L["Show %s on self"] = "顯示自己的%s"
L["Menu Direction"] = "選單方向"
L["Shows shield charges in place of the timer"] = "顯示盾的充能次數而不是時間"
L["ES Target Name"] = "目標名字"
L["ES Main Tank Menu"] = "主坦選單"
L["You did not create any totem sets yet."] = "你還沒有建立任何圖騰組合。"
L["/Default"] = "/預設"
L["Cooldown Opacity"] = "冷卻透明度"
L["Opacity of the cooldown swirls"] = "冷卻轉圈動畫的透明度"
L['Positioning'] = "位置"
L["Hide Multicast Button"] = "隱藏多重施法按鈕"
L["Hides multicast button for switching sets. Totems are still assigned to Call of Elements if Multicast option is enabled"] = "切換組合隱藏多重施法按鈕。多重施法啟用時，圖騰仍然指定給元素呼喚。"
L["Positioning"] = "位置"